    ...
    <ul class="nav">
            ...
            <div class="profile-desc">
                <div class="profile-pic">
                    <div class="count-indicator">
                        <img class="img-xs rounded-circle " src="/admin/assets/images/faces/face21.jpg" alt="">
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
                ...
                <span class="menu-title">Deliver Boys</span>
                <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{url('deliver-boy')}}">Add </a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{url('show-deliver-boys')}}">Show </a></li>
